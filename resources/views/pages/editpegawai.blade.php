            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="horizontal dark">
                        <p class="text-uppercase text-sm">Update Golongan</p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <hr class="horizontal dark">
                        <p class="text-uppercase text-sm">Update Jabatan</p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <hr class="horizontal dark">
                        <p class="text-uppercase text-sm">Update Pendidikan</p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <hr class="horizontal dark">
                        <p class="text-uppercase text-sm">Update Penempatan</p>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
